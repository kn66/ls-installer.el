;;; lsp-installer-jdtls.el --- JDT Language Server installation for lsp-installer -*- lexical-binding: t; -*-

;; Copyright (C) 2025

;;; Commentary:

;; This file contains JDT Language Server specific installation functions for lsp-installer.

;;; Code:

;;; JDT Language Server installation functions

(defun lsp-installer--install-jdtls
...
TARGET-SUBDIR is optional subdirectory to extract to."
  (let* ((server-dir
         ...
         (temp-dir (make-temp-file "lsp-installer-jdtls-" t))
    ...
    (unwind-protect
        (progn
          ...
          (lsp-installer--create-jdtls-wrapper server-name extract-dir)
...
JDTLS-DIR is the directory where JDT LS is installed."
  (let* ((server-dir
    ...
    (with-temp-file wrapper-script
      ...
      (insert "# Generated by lsp-installer\n")
      (insert "\n")
    ...
    (when (eq system-type 'windows-nt)
      (let ((bat-script (concat wrapper-script ".bat")))
        (with-temp-file bat-script
          ...
          (insert "REM Generated by lsp-installer\n")
          (insert "\n")
...
(defun lsp-installer-jdtls-command-info ()
  ...
  (let* ((server-dir (lsp-installer--get-server-install-dir "jdtls"))
...
(provide 'lsp-installer-jdtls)

;;; lsp-installer-jdtls.el ends here
